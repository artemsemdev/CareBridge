...
- Assuming good intent while still being technically rigorous.
- Taking responsibility for mistakes and learning from them.
- Focusing on what is best for the project and its users.
- Respecting the synthetic-data-only scope of this repository and never sharing real patient or sensitive personal data.
...
- Sharing secrets, credentials, real patient data, or other sensitive material in issues, pull requests, discussions, screenshots, or logs.
...
To report unacceptable behavior, contact the repository maintainer through the contact options listed on the GitHub profile for [@artemsemdev](https://github.com/artemsemdev). Reports will be reviewed and investigated promptly and fairly.
